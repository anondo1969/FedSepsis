...
def training_neural_network_model(batch_size, config, data_from_train_file, hyper_parameters, experiment_number, time_window, all_pos_all_neg, change, time_stamp):
    ...
    criterion = nn.CrossEntropyLoss(reduction='mean', ignore_index=pad_integer)
    ...
    loss_info_file_name = save_dir+'training_loss_information_'+str(time_window)+'_hours_time_stamp.txt'
