...
def load_decoding_details(config, value, time_window, change, time_stamp):
    ...
    try:
        ...
        with open(save_dir+str(time_window)+'_hours_'+change+"_"+time_stamp+"_decoding_details_"+str(value), "rb") as fp:
            decoding_details = pickle.load(fp)
        os.remove(save_dir+str(time_window)+'_hours_'+change+"_"+time_stamp+"_decoding_details_"+str(value)) 
